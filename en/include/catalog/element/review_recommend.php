...
if ($reviewCnt)
{
    $recommendPercent = ceil((100/$reviewCnt)*$recommendCnt);
    if ($recommendPercent>100)
...
<div class="assessment">
    <h3 class="assessment-count"><?=$avgRating?></h3>
    <div class="assessment-icon">
        <?
        for ($i=1;$i<=5;$i++)
        {
        $fillColor = $avgRating>=$i ? '#F4AF48' : '#E6E2D9';
        ?>
    ...
    <div class="assessment-content">
        ...
        <p>
            ...
            <?=$recommendPercent?>% клиентов рекомендуют этот товар
        </p>
    </div>
</div>
