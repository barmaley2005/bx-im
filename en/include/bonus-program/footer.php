...
<section class="section sale _join">
    <div class="container">
        <div class="sale-container">
            <div class="sale-form">
                <div class="sale-form__content">
                    ...
                    <h2 class="title sale-form__title">Стать участником</h2>
                    <h4 class="sale-form__subtitle">ORENSHAL CLUB</h4>
                </div>

                <button class="sale-form__button submit" data-action="showRegistrationForm">Зарегистрироваться</button>

            </div>
            <div class="sale-img">
                <img src="/local/templates/oren/img/sale/img-2.jpg" alt="" loading="lazy">
            </div>
        </div>
    </div>
</section>
