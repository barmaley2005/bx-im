...
class Products
{
	public static function MainParams($mode='')
	{
			$arShowParams = array(
						...
						"messTree" => array(
											...
											"ADD_CONTROL" => GetMessage("logictim.balls_SELECT_COND_ADD_BONUS_GROUP"),
	...
	public static function Controls($mode='')
	{
		...
		$params[] = array(
							"controlId" => 'conditionGroup',
							'group'=> true,
							'label'=> GetMessage("logictim.balls_SELECT_COND_ADD_BONUS"),
							...
							'control'=> array(
												GetMessage("logictim.balls_SELECT_COND_ADD_BONUS_TEXT"),
												array
												(
													'id' => 'bonus',
													'name' => 'bonus',
												...
												(
													...
													'name' => 'round_method',
													'type' => 'select',
													'values' => array('MATH'=>GetMessage("logictim.balls_ROUND_MATH"), 'UP'=>GetMessage("logictim.balls_ROUND_UP"), 'DOWN'=>GetMessage("logictim.balls_ROUND_DOWN")),
													'defaultValue' => 'MATH',
													'defaultText' => GetMessage("logictim.balls_ROUND_MATH"),
												),
												GetMessage("logictim.balls_FOR_PRODUCT"),
												array
												(
													'id' => 'All',
													'name' => 'All',
		...
		$params[] = array(
							...
							'group'=> true,
							'label'=> GetMessage("logictim.balls_SELECT_COND_ADD_BONUS_GROUP_FROM_PROPS"),
							'showIn'=> array('CondGroup'),
							'visual'=> array(
												'controls' => array('All', 'True'),
												'values' => array(
							...
							'control'=> array(
												GetMessage("logictim.balls_COND_ADD_BONUS_FROM_PROP"),
												array
												(
													'id' => 'bonus_from_props',
												...
												GetMessage("logictim.balls_COND_ADD_BONUS_FROM_PROP_TYPE"),
												array
												(
													'id' => 'bonus_type',
													'name' => 'bonus_type',
												...
												GetMessage("logictim.balls_ROUND_LABEL_SHORT"),
												array
												(
													'id' => 'round',
													'name' => 'round',
		...
		$params[] = array(
							...
							'group'=> true,
							'label'=> GetMessage("logictim.balls_SELECT_COND_ADD_BONUS_ORDER"),
							'showIn'=> array('CondGroup'),
							'visual'=> array(
												'controls' => array('All', 'True'),
												'values' => array(
							...
							'control'=> array(
												GetMessage("logictim.balls_SELECT_COND_ADD_BONUS_ORDER_TEXT"),
												array
												(
													'id' => 'bonus',
													'name' => 'bonus',
												...
												/*GetMessage("logictim.balls_FIX_IF"),
												array
												(
													'id' => 'All',
													'name' => 'All',
