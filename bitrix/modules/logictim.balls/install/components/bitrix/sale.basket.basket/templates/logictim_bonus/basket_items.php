							...
							?>
								<td class="price">
									...
									<?endif;?>
                                    	...
                                    	<? if($arBonus["ITEMS"][$arItem["ID"]]["ADD_BONUS_UNIT"] > 0) {?>
                                        <div class="bonus bonus_unit_cart" id="bonus_unit_<?=$arItem["ID"]?>">
                                        	+ <?=$arBonus["ITEMS"][$arItem["ID"]]["ADD_BONUS_UNIT"];?> <?=COption::GetOptionString("logictim.balls", "TEXT_BONUS_FOR_ITEM", '')?>
                                        </div>
                                        <? }?>
								</td>
							<?
							...
							?>
								<td class="custom">
									...
									?>
                                        ...
                                        <? if($arBonus["ITEMS"][$arItem["ID"]]["ADD_BONUS"] > 0) {?>
                                        <div class="bonus bonus_item_cart" id="bonus_sum_<?=$arItem["ID"]?>">
                                            + <?=$arBonus["ITEMS"][$arItem["ID"]]["ADD_BONUS"];?> <?=COption::GetOptionString("logictim.balls", "TEXT_BONUS_FOR_ITEM", '')?>
                                        </div>
                                        <? }?>
									<?
									endif;
		...
		<div class="bx_ordercart_order_pay_right">
			<table class="bx_ordercart_order_sum">
				...
				<?endif;?>
                    ...
                    <tr>
						<td class="fwb"></td>
						<td class="fwb" id="all_bonus">+ <?=$arBonus["ALL_BONUS"];?> <?=COption::GetOptionString("logictim.balls", "TEXT_BONUS_FOR_ITEM", '')?></td>
					</tr>
                    <? }?>
