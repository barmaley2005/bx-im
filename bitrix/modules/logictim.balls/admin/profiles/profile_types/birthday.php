<?
$APPLICATION->SetTitle(GetMessage("logictim.balls_BONUS_FROM_BIRTHDAY"));
...
<section class="">
    ...
    <form class="logictim_profile" name="logictim_profile" method="post" action="<?echo $APPLICATION->GetCurPage()?>?lang=<?=LANGUAGE_ID?>">
		...
		<? $tabControl->BeginNextTab();?>
				...
				{
					$active = 'Y';
					$profileName = GetMessage("logictim.balls_BONUS_FROM_BIRTHDAY");
					$sort = 100;
					$activeAfter = 0;
					$activeAfterType = 'D';
					$deActiveAfter = 365;
				...
				<tr><td width="40%"><?=GetMessage("logictim.balls_PROFILE_TYPE")?></td><td><?=GetMessage("logictim.balls_BONUS_FROM_BIRTHDAY")?></td></tr>
                <? if($profileId > 0) {?>
